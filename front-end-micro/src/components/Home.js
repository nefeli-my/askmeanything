      ...
      <div className="options-div">
        ...
        <div className="row">
          <div className="col-sm" onClick={() => history.push('/profile')}>
            ...
            you have given,<br/> as well as <b>statistics</b> and <b>
            general information </b> about your <b>account</b>.
            </p>
            <div>
          ...
          <div className="col-sm" onClick={() => history.push('/new-question')}>
            ...
            in a <b>simple</b> and<br/> <b>clear way</b> and don't forget to
            <br/>add the necessary <b>keywords</b>.
            </p>
            <div>
